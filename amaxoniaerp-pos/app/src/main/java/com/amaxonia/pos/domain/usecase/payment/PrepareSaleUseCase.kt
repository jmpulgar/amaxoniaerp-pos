...
internal class PrepareSaleUseCase(
...
internal class AssemblePreparedSaleUseCase(
    private val repositories: PaymentFlowRepositories,
    private val operations: PaymentPreparationOperations,
) {
