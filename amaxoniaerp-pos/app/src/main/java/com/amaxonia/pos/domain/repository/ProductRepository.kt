...
interface ProductTaxonomyReader {
...
interface ProductCatalogReader {
...
/** Compatibility facade retained while consumers migrate to role-specific ports. */
interface ProductRepository :
    ProductTaxonomyReader,
