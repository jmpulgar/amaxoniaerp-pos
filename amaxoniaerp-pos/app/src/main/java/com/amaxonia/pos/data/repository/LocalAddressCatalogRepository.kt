...
class LocalAddressCatalogRepository(
    ...
    override suspend fun getCountries(): List<Country> {
        return countryDao.getAll().map { it.toDomain() }
    }
    ...
    override suspend fun getAddressLevel2(countryCode: String, level1Code: String): List<AddressLevel> {
    ...
    override suspend fun getAddressLevel3(countryCode: String, level2Code: String): List<AddressLevel> {
