...
class MockProductRepository : ProductRepository {
    ...
    override suspend fun getBrands(): Result<List<Department>> = Result.success(listOf(Department(1, "Marca 1"), Department(2, "Marca 2")))
    ...
    override suspend fun getProductStock(id: String): Result<ProductStock> {
        ...
        val available = ((1..20).random() + Random.nextDouble()).let { String.format(java.util.Locale.getDefault(), "%.2f", it).toDouble() }
        ...
        for (i in 1..200) {
            mockProducts.add(
                Product(
                    ...
                    costActual = 10.0 + i,
                    prices =
                        generateDefaultPrices().map { level ->
