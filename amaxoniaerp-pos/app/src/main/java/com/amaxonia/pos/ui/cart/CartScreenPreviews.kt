...
@Composable
private fun CartItemRowCompact320() = PosTheme {
...
@Composable
private fun CartItemRowBigAmounts() = PosTheme {
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        Box(modifier = Modifier.fillMaxWidth().padding(16.dp)) {
            PreviewCartItemRow(
                item =
...
@Composable
private fun CartItemRowSimple() = PosTheme {
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        Box(modifier = Modifier.fillMaxWidth().padding(16.dp)) {
            PreviewCartItemRow(
...
@Composable
private fun CartBottomBar320() = PosTheme {
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        CartBottomBar(
            total = 248.75,
            secondaryTotal = null,
...
@Composable
private fun CartBottomBarHugeTotal() = PosTheme {
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        CartBottomBar(
            total = 9_876_543.21,
            secondaryTotal = null,
...
@Composable
private fun CartBottomBarMultiCurrency() = PosTheme {
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        CartBottomBar(
            total = 1_289.50,
...
@Composable
private fun CartBottomBarLandscapeCompact() = PosTheme {
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        CartBottomBar(
            total = 248.75,
...
@Composable
private fun CartPanelAssigned() = PosTheme {
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
...
@Composable
private fun CartPanelEmpty() = PosTheme {
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        CartClientVendorPanel(
            state = CartState(),
            onSelectClient = {},
...
@Composable
private fun PreviewCartItemRow(item: CartItem) {
    CartItemRow(
        item = item,
        onIncrease = {},
        onDecrease = {},
