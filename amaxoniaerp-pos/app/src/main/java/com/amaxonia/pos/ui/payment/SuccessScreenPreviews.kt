...
@Composable
internal fun SuccessPortrait320() =
    PosTheme {
...
@Composable
internal fun SuccessPortrait360() =
    PosTheme {
        Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
            SuccessContent(
                isLoading = false,
...
@Composable
internal fun SuccessPortrait390MultiCurrency() =
    PosTheme {
        Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
            SuccessContent(
                isLoading = false,
...
@Composable
internal fun SuccessPortrait412FiscalPending() =
    PosTheme {
        Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
            SuccessContent(
                isLoading = false,
...
@Composable
internal fun SuccessPortrait480BigChange() =
    PosTheme {
        Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
            SuccessContent(
                isLoading = false,
...
@Composable
internal fun SuccessLandscapePhone() =
    PosTheme {
        Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
            SuccessContent(
                isLoading = false,
...
@Composable
internal fun SuccessLoadingPreview() =
    PosTheme {
        Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
            SuccessContent(
                isLoading = true,
