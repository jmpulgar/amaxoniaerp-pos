...
internal fun mapHeaderContext(
    ...
    return CreditNoteHeaderContext(
        ...
        observacion = row[headerTable.observacion].orEmpty(),
        clienteNombre = clienteNombre,
        clienteIdentificacion = row[ClientsTable.rif].orEmpty(),
        clienteDireccion = row[CreditNoteFacturaTable.facturarADireccion].orEmpty(),
        clienteTelefono = row[CreditNoteFacturaTable.facturarATelefono].orEmpty(),
