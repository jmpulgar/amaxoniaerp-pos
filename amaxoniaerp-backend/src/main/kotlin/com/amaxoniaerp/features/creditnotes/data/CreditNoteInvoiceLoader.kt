...
internal fun loadInvoiceHeader(invoiceId: String): InvoiceHeader? {
    ...
    return InvoiceHeader(
        ...
        formaPago = row[CreditNoteFacturaTable.formaPago].orEmpty().ifBlank { "contado" },
        idCajaSecuencia = row[CreditNoteFacturaTable.idCajaSecuencia].orEmpty(),
        idCaja = row[CreditNoteFacturaTable.idCaja].orEmpty(),
        idSucursal = row[CreditNoteFacturaTable.idSucursal] ?: 1,
        serieSucursal = row[CreditNoteFacturaTable.serieSucursal].orEmpty(),
        codigoCaja = row[CreditNoteFacturaTable.codigoCaja].orEmpty(),
        facturarA = row[CreditNoteFacturaTable.facturarA].orEmpty(),
        facturarARuc = row[CreditNoteFacturaTable.facturarARuc].orEmpty(),
        facturarADireccion = row[CreditNoteFacturaTable.facturarADireccion].orEmpty(),
        facturarATelefono = row[CreditNoteFacturaTable.facturarATelefono].orEmpty(),
