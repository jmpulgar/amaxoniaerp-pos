...
object CreditNoteAbonoTable : Table("abono") {
    ...
    val codAbono = varchar("codigo", 50)
    ...
    val idOperacion = varchar("id_operacion", 36)
    val codigoReparacion = varchar("codigo_reparacion", 50)
    val fechaCreacion = datetime("fecha_creacion")
    val usuarioCreacion = varchar("usuario_creacion", 50)
    val fechaModificacion = datetime("fecha_modificacion")
    val usuarioModificacion = varchar("usuario_modificacion", 50)
    val fechaAnulacion = datetime("fecha_anulacion")
    val usuarioAnulacion = varchar("usuario_anulacion", 50)
