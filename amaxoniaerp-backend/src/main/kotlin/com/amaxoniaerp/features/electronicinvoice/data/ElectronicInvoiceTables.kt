...
object FEFacturaReadTable : Table("factura") {
    ...
    val naturalezaOperacion = varchar("NaturalezaOperacion", SchemaDimensions.VARCHAR_LENGTH_5).nullable()
    val tipoOperacion = varchar("tipoOperacion", SchemaDimensions.VARCHAR_LENGTH_5).nullable()
    val formatoCAFE = varchar("formatoCAFE", SchemaDimensions.VARCHAR_LENGTH_5).nullable()
    val entregaCAFE = varchar("entregaCAFE", SchemaDimensions.VARCHAR_LENGTH_5).nullable()
    val envioContenedor = varchar("envioContenedor", SchemaDimensions.VARCHAR_LENGTH_5).nullable()
    val tipoVenta = varchar("tipoVenta", SchemaDimensions.VARCHAR_LENGTH_5).nullable()
...
object FETipoClienteReadTable : Table("tipo_cliente") {
    val codTipoCliente = integer("cod_tipo_cliente")
    val tipoClienteFE = varchar("TipoClienteFE", SchemaDimensions.VARCHAR_LENGTH_5).nullable()
...
object FEPaisesReadTable : Table("paises") {
    val id = integer("id")
    val iso = varchar("iso", SchemaDimensions.VARCHAR_LENGTH_5)
    val nombre = varchar("nombre", SchemaDimensions.VARCHAR_LENGTH_100)
...
object FEParametrosReadTable : Table("parametros_generales") {
    ...
    val direccionEnvio = varchar("direccion_envio", SchemaDimensions.VARCHAR_LENGTH_500).nullable()
    val api_thefactoryhka = varchar("api_thefactoryhka", SchemaDimensions.VARCHAR_LENGTH_500).nullable()
    val tipoEmision = varchar("tipoEmision", SchemaDimensions.VARCHAR_LENGTH_5).nullable()
    val destinoOperacion = varchar("destinoOperacion", SchemaDimensions.VARCHAR_LENGTH_5).nullable()
    ...
    val fechaInicioContingencia = varchar("fechaInicioContingencia", SchemaDimensions.VARCHAR_LENGTH_30).nullable()
    val motivoContingencia = varchar("motivoContingencia", SchemaDimensions.VARCHAR_LENGTH_300).nullable()
...
object FEUnidadEmpaquesReadTable : Table("unidad_empaques") {
    ...
    val simbolo = varchar("simbolo", SchemaDimensions.VARCHAR_LENGTH_20).nullable()
...
object FEFacturaDetalleFormaPagoReadTable : Table("factura_detalle_formapago") {
    ...
    val totalizarMontoRetencion = decimal("totalizar_monto_retencion", SchemaDimensions.DECIMAL_PRECISION_10, 2).nullable()
    val totalizarMontoCancelar = decimal("totalizar_monto_cancelar", SchemaDimensions.DECIMAL_PRECISION_10, 2).nullable()
