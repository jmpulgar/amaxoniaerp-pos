...
internal class CajaHandlers(
    ...
    suspend fun status(call: ApplicationCall) = run {
        val ctx = call.resolveCajaCompanyContext() ?: return@run
    ...
    suspend fun resumenSecuencia(call: ApplicationCall) = run {
        val ctx = call.resolveCajaCompanyContext() ?: return@run
    ...
    suspend fun datosSecuencia(call: ApplicationCall) = run {
        val ctx = call.resolveCajaCompanyContext() ?: return@run
    ...
    suspend fun codigoSecuencia(call: ApplicationCall) = run {
        val ctx = call.resolveCajaCompanyContext() ?: return@run
    ...
    suspend fun cerrar(call: ApplicationCall) = run {
        val ctx = call.resolveCajaCompanyContext() ?: return@run
 ...
 */
internal suspend fun ApplicationCall.resolveCajaCompanyContext(): CajaCompanyContext? = run {
