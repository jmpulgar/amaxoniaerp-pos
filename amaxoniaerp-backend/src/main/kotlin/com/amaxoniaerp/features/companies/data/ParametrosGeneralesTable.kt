 ...
 */
abstract class BaseParametrosGeneralesTable(name: String = "parametros_generales") : Table(name) {
 ...
 */
abstract class BaseTasasCambioTable(name: String = "tasas_cambio") : Table(name) {
    val id          = long("id")
