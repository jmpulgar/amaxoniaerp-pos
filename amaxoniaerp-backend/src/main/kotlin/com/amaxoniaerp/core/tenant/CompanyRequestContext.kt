 ...
 */
suspend fun ApplicationCall.resolveCompanyRequestContext(): CompanyRequestContext? = run {
...
suspend fun CompanyRequestContext.requireUserId(call: ApplicationCall): Int? = run {
 ...
 */
suspend fun CompanyRequestContext.requireCompanyDbHeader(call: ApplicationCall): String? = run {
